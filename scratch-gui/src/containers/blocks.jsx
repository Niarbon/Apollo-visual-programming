...
class Blocks extends React.Component {
    ...
    setLocale () {
        this.ScratchBlocks.ScratchMsgs.setLocale(this.props.locale);
        const normalizedLocale = (this.props.locale || '').toLowerCase().replace('_', '-');
        if (normalizedLocale === 'zh-cn' && this.ScratchBlocks && this.ScratchBlocks.Msg) {
            this.ScratchBlocks.Msg.MOTION_MOVESTEPS = '向前移动 %1 步';
        }
